...
short CalculatePeriodLength(sPeriod Period1, bool IncludeEndDay = false) {
...
int main()
{
    ...
    cout << "\n\nPeriod Length is: " << CalculatePeriodLength(Period1);
    cout << "\nPeriod Length (Including End Date) is: " << CalculatePeriodLength(Period1, true);
